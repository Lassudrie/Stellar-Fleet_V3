...
import { FactionId, StarSystem } from '../../../shared/shared';
import { useI18n } from '../../i18n';
import { sorted } from '../../../shared/shared';

// ------------------------------------------------------------
// UI positioning (was: ui/components/ui/positioning/computeConstrainedMenuPosition.ts)
// ------------------------------------------------------------
...
const SystemContextMenu: React.FC<SystemContextMenuProps> = ({
  ...
  const menuTitleId = useMemo(() => `system-context-title-${system.id}`, [system.id]);
  ...
  const hasOperationsSection = Boolean(
      groundForces || showGroundOpsOption || showLoadOption || showUnloadOption || showInvadeOption
  );
  ...
  return (
    ...
    >
      <div id={menuTitleId} className="px-3 py-2 text-xs font-bold text-blue-200 border-b border-slate-700 mb-1 uppercase tracking-wider flex items-center gap-2">
      ...
      <div className="px-3 pt-2 pb-1 text-[10px] uppercase tracking-[0.18em] text-slate-400">
      ...
      <button
          ...
          className="text-left px-3 py-2 rounded transition-colors text-sm font-semibold tracking-wide flex items-center gap-2 text-slate-200 hover:text-white hover:bg-slate-700/50"
      >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="px-3 pt-2 pb-1 text-[10px] uppercase tracking-[0.18em] text-slate-400">
          {t('ctx.section.actions')}
      </div>
      {canSelectFleet && (
          <button
              onClick={onSelectFleetAtSystem}
              className="text-left px-3 py-2 rounded transition-colors text-sm font-semibold tracking-wide flex items-center gap-2 hover:bg-indigo-600/20 text-indigo-300 hover:text-white"
          >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <button
          ...
          className="text-left px-3 py-2 rounded transition-colors text-sm font-semibold tracking-wide flex items-center gap-2 hover:bg-blue-600/20 text-blue-300 hover:text-white"
      >
          ...
          <>
              ...
              {showLoadOption && (
                  <button
                      ...
                      className="text-left px-3 py-2 rounded transition-colors text-sm font-semibold tracking-wide flex items-center gap-2 hover:bg-emerald-600/20 text-emerald-300 hover:text-white"
                  >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              {showUnloadOption && (
                  <button
                      ...
                      className="text-left px-3 py-2 rounded transition-colors text-sm font-semibold tracking-wide flex items-center gap-2 hover:bg-amber-600/20 text-amber-300 hover:text-white"
                  >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              {showInvadeOption && (
                  <button 
                      onClick={onInvade}
                      className="text-left px-3 py-2 bg-red-900/20 hover:bg-red-600/40 text-red-300 hover:text-white rounded transition-colors text-sm font-semibold tracking-wide flex items-center gap-2 border border-red-500/30"
                  >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <button 
          onClick={onClose}
          className="text-left px-3 py-2 rounded transition-colors text-sm text-slate-400 hover:text-white hover:bg-white/10"
      >
          {t('ctx.cancel')}
      </button>
    </div>
