...
export const STARFIELD_BASE_COLOR = '#000000';
export const STARFIELD_BASE_TINT_STRENGTH = 0.0;
export const STARFIELD_NEBULA_STRENGTH_MIN = 0.001;
export const STARFIELD_NEBULA_STRENGTH_MAX = 0.01;
export const STARFIELD_NEBULA_TINT_MIN = 0.08;
export const STARFIELD_NEBULA_TINT_MAX = 0.22;
...
export const LENS_FLARE_BASE_STRENGTH = 0.12;
...
export const SURFACE_NORMAL_SCALE = 1.1;
export const SURFACE_AO_INTENSITY = 0.6;
export const SURFACE_DISPLACEMENT_SCALE = 0.05;
export const SURFACE_DISPLACEMENT_BIAS = -0.025;
export const GAS_GIANT_NORMAL_STRENGTH = 0.35;
export const SYSTEM_VIEW_FIXED_TERMINATOR = true;
export const OWNER_TINT_STRENGTH = 0.22;
export const CITY_LIGHTS_INTENSITY_MIN = 0.18;
export const CITY_LIGHTS_INTENSITY_MAX = 1.0;
export const CITY_LIGHTS_DIAMETER_MIN_PX = 60;
export const CITY_LIGHTS_DIAMETER_FULL_PX = 260;
export const HIGH_DETAIL_GEOMETRY_DIAMETER_PX = 280;
export const HIGH_DETAIL_GEOMETRY_HYSTERESIS_PX = 50;

export const DAY_NIGHT_TERMINATOR_SOFTNESS = 0.28;
export const DAY_NIGHT_NIGHT_MIN = 0.08;
export const DAY_NIGHT_TERMINATOR_SOFTNESS_ATMOSPHERE = 0.36;
export const DAY_NIGHT_NIGHT_MIN_ATMOSPHERE = 0.1;
export const ATMOSPHERE_HALO_STRENGTH = 0.6;
export const ATMOSPHERE_HALO_K = 4.0;
export const ATMOSPHERE_HALO_M = 2.0;
export const ATMOSPHERE_HALO_BOOST_MAX = 1.4;
export const ATMOSPHERE_HALO_NEAR_FACTOR = 3.0;
export const ATMOSPHERE_HALO_FAR_FACTOR = 30.0;
export const ATMOSPHERE_HALO_THICKNESS = 0.018;
