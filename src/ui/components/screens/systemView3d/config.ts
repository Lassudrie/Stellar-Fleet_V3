...
export const ATMOSPHERE_SHELL_DISTANCE_BOOST_MAX = 1.4;
export const ATMOSPHERE_SHELL_DISTANCE_NEAR_FACTOR = 3.0;
export const ATMOSPHERE_SHELL_DISTANCE_FAR_FACTOR = 30.0;
