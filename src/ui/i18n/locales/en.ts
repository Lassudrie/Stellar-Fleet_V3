...
export const en = {
  ...
  'systemView.bodySubType.planet.Terrestrial': 'Terrestrial',
  'systemView.bodySubType.planet.SubNeptune': 'Sub-Neptune',
  'systemView.bodySubType.planet.IceGiant': 'Ice Giant',
  'systemView.bodySubType.planet.GasGiant': 'Gas Giant',
  'systemView.bodySubType.planet.Dwarf': 'Dwarf',
  'systemView.bodySubType.moon.Regular': 'Regular',
  'systemView.bodySubType.moon.Icy': 'Icy',
  'systemView.bodySubType.moon.Volcanic': 'Volcanic',
  'systemView.bodySubType.moon.Eden': 'Eden',
  'systemView.bodySubType.moon.Irregular': 'Irregular',
  ...
  'surfaceView.backToGalaxy': 'Zoom out to galaxy',
  'surfaceView.backToSystem': 'Zoom out to system',
