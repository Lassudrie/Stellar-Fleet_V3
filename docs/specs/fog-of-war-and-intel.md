...
Cette spécification décrit la manière dont Stellar Fleet gère la visibilité des entités (systèmes et flottes), la production de renseignements sous forme de **sightings** (observations ennemies) et leur dégradation temporelle. Elle précise également comment l'IA exploite le brouillard de guerre et la mémoire des sightings (omniscience vs perception limitée).
...
* Une flotte ennemie masquée peut nécessiter la désélection automatique si elle était sélectionnée.
...
Lors du recalcul de l'état filtré :
...
## 4. Renseignement et brouillard côté IA

### 4.1. Omniscience vs perception limitée
