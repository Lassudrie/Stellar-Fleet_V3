...
Note surfaces :
- Le moteur de surface (PlanetSurface) utilise un champ de terrain continu (TerrainField v6) comme source de vérité, puis dérive la carte 2D et des données secondaires via sampling déterministe.
